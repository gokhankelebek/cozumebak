...
export const TOPICS: Topic[] = [
  ...
  { slug: "karesel-fonksiyonlar-10", title: "İkinci Dereceden Fonksiyonlar ve Parabol", track: "10", unit: "nicelikler-degisimler-10", summary: "Karesel fonksiyonun grafiği, tepe noktası ve eksen kesişimleri.", minutes: 8, difficulty: "Orta", questionCount: 20, status: "published", keywords: ["parabol", "tepe noktası"] },
  { slug: "ikinci-derece-denklem-esitsizlik-10", title: "İkinci Dereceden Denklem ve Eşitsizlikler", track: "10", unit: "nicelikler-degisimler-10", summary: "Diskriminant, kök bulma ve ikinci derece eşitsizliklerin işareti.", minutes: 8, difficulty: "Orta", questionCount: 22, status: "published", keywords: ["diskriminant", "delta"] },
  { slug: "karekok-rasyonel-fonksiyon-10", title: "Karekök ve Rasyonel Fonksiyonlar", track: "10", unit: "nicelikler-degisimler-10", summary: "Karekök ve rasyonel fonksiyonların tanım kümesi, grafiği ve özellikleri.", minutes: 8, difficulty: "Orta", questionCount: 18, status: "published", keywords: ["karekök fonksiyonu", "rasyonel fonksiyon", "asimptot"] },
  ...
  { slug: "dik-ucgen-trigonometri-10", title: "Dik Üçgende Trigonometrik Oranlar ve Özdeşlikler", track: "10", unit: "geometrik-sekiller-10", summary: "Sinüs, kosinüs, tanjant oranları ve temel trigonometrik özdeşlikler.", minutes: 9, difficulty: "Orta", questionCount: 24, status: "published", keywords: ["sinüs", "kosinüs", "tanjant", "trigonometri"] },
  { slug: "ucgende-yardimci-elemanlar-10", title: "Üçgende Yardımcı Elemanlar", track: "10", unit: "geometrik-sekiller-10", summary: "Açıortay, kenarortay, kenar orta dikme ve yükseklik.", minutes: 8, difficulty: "Orta", questionCount: 18, status: "published", keywords: ["açıortay", "kenarortay", "yükseklik"] },
  { slug: "ucgende-alan-10", title: "Üçgende Alan", track: "10", unit: "geometrik-sekiller-10", summary: "Taban-yükseklik, iki kenar-sinüs ve özel alan formülleri.", minutes: 8, difficulty: "Orta", questionCount: 20, status: "published", keywords: ["alan", "üçgen alanı"] },
  { slug: "sinus-kosinus-teoremi-10", title: "Sinüs ve Kosinüs Teoremleri", track: "10", unit: "geometrik-sekiller-10", summary: "Sinüs ve kosinüs teoremiyle kenar ve açı hesabı.", minutes: 8, difficulty: "Zor", questionCount: 18, status: "published", keywords: ["sinüs teoremi", "kosinüs teoremi"] },

  // ── 10. Sınıf · Analitik İnceleme ──
  { slug: "iki-nokta-uzaklik-10", title: "Koordinat Düzleminde Nokta ve İki Nokta Arası Uzaklık", track: "10", unit: "analitik-inceleme-10", summary: "Koordinat düzleminde nokta ve uzaklık formülü.", minutes: 7, difficulty: "Orta", questionCount: 16, status: "published", keywords: ["uzaklık", "koordinat"] },
