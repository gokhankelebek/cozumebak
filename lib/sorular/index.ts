...
import asalCarpanlarBolenler10 from "./asal-carpanlar-bolenler-10";
import bagimliBagimsizOlaylar10 from "./bagimli-bagimsiz-olaylar-10";
import bayesTeoremi10 from "./bayes-teoremi-10";
...
import ikiNoktaUzaklik10 from "./iki-nokta-uzaklik-10";
import ikinciDereceDenklemAyt from "./ikinci-derece-denklem-ayt";
import ikinciDereceDenklemEsitsizlik10 from "./ikinci-derece-denklem-esitsizlik-10";
...
import islemlerinAlgoritmasi10 from "./islemlerin-algoritmasi-10";
import karekokRasyonelFonksiyon10 from "./karekok-rasyonel-fonksiyon-10";
import kareselFonksiyonlar10 from "./karesel-fonksiyonlar-10";
...
import saymaPermutasyon10 from "./sayma-permutasyon-10";
...
const BANKS: Record<string, TopicQuiz> = {
  ...
  [asalCarpanlarBolenler10.slug]: asalCarpanlarBolenler10,
  [bagimliBagimsizOlaylar10.slug]: bagimliBagimsizOlaylar10,
  [bayesTeoremi10.slug]: bayesTeoremi10,
  ...
  [ikiNoktaUzaklik10.slug]: ikiNoktaUzaklik10,
  [ikinciDereceDenklemAyt.slug]: ikinciDereceDenklemAyt,
  [ikinciDereceDenklemEsitsizlik10.slug]: ikinciDereceDenklemEsitsizlik10,
  ...
  [islemlerinAlgoritmasi10.slug]: islemlerinAlgoritmasi10,
  [karekokRasyonelFonksiyon10.slug]: karekokRasyonelFonksiyon10,
  [kareselFonksiyonlar10.slug]: kareselFonksiyonlar10,
  ...
  [saymaPermutasyon10.slug]: saymaPermutasyon10,
