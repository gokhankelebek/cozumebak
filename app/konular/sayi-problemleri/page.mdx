...
1. Satılan oran: $\dfrac{2}{5}+\dfrac{3}{10}=\dfrac{4}{10}+\dfrac{3}{10}=\dfrac{7}{10}$.

2. Kalan oran: $1-\dfrac{7}{10}=\dfrac{3}{10}$; bu kesir $24$ kg'a karşılık gelir.

3. Toplam $x$ olsun: $\dfrac{3}{10}x=24\Rightarrow x=24\cdot\dfrac{10}{3}=80$.

4. **Doğrulama:** $\dfrac{7}{10}\cdot 80=56$ kg satılır, $80-56=24$ kg kalır. ✓
...
1. Birler rakamı $b$, onlar rakamı $2b$ olsun. Toplam: $2b+b=3b=12\Rightarrow b=4$.

2. Onlar rakamı $2b=8$, birler rakamı $4$. Sayı: $84$.
...
1. $10$ TL'lik sayısı $x$, $5$ TL'lik sayısı $24-x$ olsun.

2. Toplam para: $10x+5(24-x)=185$.

3. Dağıt: $10x+120-5x=185\Rightarrow 5x=65\Rightarrow x=13$.
