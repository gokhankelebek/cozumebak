...
import { NoktalardanDogrular } from "@/components/figures/KombinasyonFig";
...
<Altyazi>Şekil 1 — Üçü doğrusal olmayan $6$ noktanın belirlediği $15$ doğru. Bir doğru, $2$ noktalı **sırasız** bir seçimle ($AB=BA$) belirlendiğinden sayı $C(6,2)=15$'tir. Aynı noktalardan üçer üçer **üçgen** seçseydik $C(6,3)=20$ bulurduk.</Altyazi>
...
1. $C(n,2)=\dfrac{n(n-1)}{2}=21\Rightarrow n(n-1)=42$.
2. $7\cdot 6=42$ olduğundan $n=7$.
...
1. Toplam $10$ kişiden $3$'lü grup: $C(10,3)=\dfrac{10\cdot 9\cdot 8}{6}=120$.
2. Hiç kız olmayan (hepsi erkek): $C(6,3)=\dfrac{6\cdot 5\cdot 4}{6}=20$.
3. En az $1$ kız: $120-20=100$.
...
1. Ali sabit; kalan $2$ üye diğer $6$ kişiden: $C(6,2)=\dfrac{6\cdot 5}{2}=15$.
...
1. Tüm $3$'lü seçimler: $C(9,3)=\dfrac{9\cdot 8\cdot 7}{6}=84$.
2. Doğrusal (üçgen olmayan) üçlüler, aynı doğru üzerindeki $4$ noktadan: $C(4,3)=4$.
3. Üçgen sayısı: $84-4=80$.
