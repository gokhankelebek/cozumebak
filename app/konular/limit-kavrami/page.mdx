...
import { SicramaFig } from "@/components/figures/LimitFig";
...
<Altyazi>Şekil — $x=3$'te sıçrama: soldan limit $1$ (dolu nokta), sağdan limit $5$ (içi boş nokta). İki taraflı limit, iki tek taraflı değer eşit olmadığından yoktur.</Altyazi>
