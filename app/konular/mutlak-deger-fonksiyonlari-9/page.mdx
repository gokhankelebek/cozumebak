...
1. Birinci durum: $2x-3=x+5\Rightarrow x=8$.
2. İkinci durum: $2x-3=-(x+5)\Rightarrow 2x-3=-x-5\Rightarrow 3x=-2\Rightarrow x=-\dfrac{2}{3}$.

<Cevap>$x=8$ veya $x=-\dfrac{2}{3}$.</Cevap>
...
1. İçi sıfır yap: $x-3=0\Rightarrow x=3$; bu noktada $|x-3|=0$.
2. $f(3)=-0+5=5$. Eksi işaret V'yi aşağı açtığından tepe en büyük değerdir.

<Cevap>Tepe $(3,\ 5)$; en büyük değer $5$.</Cevap>
...
2. $2x+1=-7\Rightarrow 2x=-8\Rightarrow x=-4$.

<Cevap>$x=3$ veya $x=-4$.</Cevap>
...
<Sorular slug="mutlak-deger-fonksiyonlari-9" />
