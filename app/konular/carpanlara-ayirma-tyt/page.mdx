...
<Cevap>$3x^2+5x-2=(x+2)(3x-1)$</Cevap>
...
$x^{2}-49=0$ denkleminin pozitif kökü kaçtır?
...
1. İki kare farkı: $x^{2}-49=(x-7)(x+7)=0$.

2. Kökler $7$ ve $-7$; pozitif kök $7$.
...
1. Çarpanlara ayır: $(x+2)(x+3)=0\Rightarrow x=-2$ veya $x=-3$.

2. Toplam: $-2+(-3)=-5$ (veya $x_1+x_2=-\dfrac{b}{a}=-5$).
...
$x\neq 2$ olmak üzere $\dfrac{x^{2}-4}{x-2}$ ifadesinin değeri $x=3$ için kaçtır?
...
2. Sadeleştir: $\dfrac{(x-2)(x+2)}{x-2}=x+2$ ($x\neq 2$).
