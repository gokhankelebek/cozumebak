...
A) $5$ · B) $6$ · C) $7$ · D) $25$ · E) $\sqrt{29}$

</Soru>

<Cozum>

1. $|AB|=\sqrt{(4-1)^{2}+(6-2)^{2}}=\sqrt{9+16}=\sqrt{25}=5$.
...
$(2,8)$ ile $(6,4)$ noktalarının orta noktasının $x$ koordinatı kaçtır?
...
1. Orta nokta: $\left(\dfrac{2+6}{2},\dfrac{8+4}{2}\right)=(4,6)$.
2. $x$ koordinatı $4$'tür.
...
Orijinden geçen ve $(3,4)$ noktasından geçen doğrunun eğimi kaçtır?

A) $\dfrac{3}{4}$ · B) $\dfrac{4}{5}$ · C) $1$ · D) $\dfrac{4}{3}$ · E) $\dfrac{5}{4}$

</Soru>

<Cozum>

1. $m=\dfrac{\Delta y}{\Delta x}=\dfrac{4-0}{3-0}=\dfrac{4}{3}$.

<Cevap>D) $\dfrac{4}{3}$</Cevap>
