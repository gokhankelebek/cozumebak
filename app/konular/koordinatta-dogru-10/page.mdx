...
1. $y$'yi yalnız bırak: $y=2x+4$.
2. Eğim $m=2$; $y$ kesişimi $x=0$ için $y=4$, yani $(0,\ 4)$.
...
1. $m_1=\dfrac13\Rightarrow m_2=-3$ (çünkü $\dfrac13\cdot(-3)=-1$).
2. $y=-3x+n$; $(2,5)$: $5=-3\cdot 2+n=-6+n\Rightarrow n=11$.
...
1. $m_{AB}=\dfrac{6-2}{3-1}=\dfrac{4}{2}=2$.
2. $m_{BC}=\dfrac{k-6}{5-3}=\dfrac{k-6}{2}$.
3. Eşitle: $\dfrac{k-6}{2}=2\Rightarrow k-6=4\Rightarrow k=10$.
...
1. Paralel → eğimler eşit: $m=2$. Doğru $y=2x-3$ olur.
2. $x$ kesişimi: $0=2x-3\Rightarrow x=\dfrac{3}{2}$, yani $a=\dfrac{3}{2}$.
3. $m+a=2+\dfrac{3}{2}=\dfrac{7}{2}$.

<Cevap>$\dfrac{7}{2}$.</Cevap>
...
<Sorular slug="koordinatta-dogru-10" />
