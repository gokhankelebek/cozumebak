...
Bir araç gidişte $80$ km/saat, dönüşte $60$ km/saat hızla aynı yolu gidip geliyor. Gidiş–dönüş ortalama hızı kaç km/saat'tir?

A) $68$ · B) $68{,}5$ · C) $69$ · D) $69{,}5$ · E) $70$

</Soru>

<Cozum>

1. Gidiş süresi $t_1=\dfrac{x}{80}$, dönüş süresi $t_2=\dfrac{x}{60}$.

2. Ortalama hız: $v_{\text{ort}}=\dfrac{2x}{\frac{x}{80}+\frac{x}{60}}=\dfrac{2}{\frac{1}{80}+\frac{1}{60}}$.

3. Payda: $\dfrac{1}{80}+\dfrac{1}{60}=\dfrac{3+4}{240}=\dfrac{7}{240}$. $v_{\text{ort}}=\dfrac{2\cdot 240}{7}=\dfrac{480}{7}\approx 68{,}6$ km/saat.
