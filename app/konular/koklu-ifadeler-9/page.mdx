...
import { KokSayiDogrusu } from "@/components/figures/KokSayiDogrusuFig";
...
<Altyazi>Şekil 1 — $\sqrt{2}$'nin sayı doğrusu üzerinde inşası. Dik kenarları $1$ olan dik üçgenin hipotenüsü $\sqrt{2}$'dir; bu uzunluk eksene yatırılınca $\sqrt{2}\approx 1{,}41$ noktası bulunur. Demek ki köklü sayılar da birer gerçek sayıdır.</Altyazi>
