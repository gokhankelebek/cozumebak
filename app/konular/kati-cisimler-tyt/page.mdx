...
$$V=\pi r^{2}h=\pi\cdot 2^{2}\cdot 5=20\pi.$$
2. Havuzda taban alanı $10$ olduğundan yükseklik:
$$h=\dfrac{V}{\text{taban}}=\dfrac{20\pi}{10}=2\pi\ \text{metre}.$$
(Çeldirici: hacmi $10$'a bölmeyi unutan $20\pi$, ya da yarıçap yerine çap kullanan $4$ kat hata yapar.)
...
1. Büyük küpün hacmi: $6^{3}=216$ cm³.
2. Küçük küpün hacmi: $3^{3}=27$ cm³.
3. Küçük küp sayısı:
$$\dfrac{216}{27}=8.$$
(Çeldirici: kenar oranı $\tfrac{6}{3}=2$'yi doğrudan cevap sanan A şıkkına düşer; oysa hacim oranı $2^{3}=8$'dir.)
...
1. Koni hacmi:
$$V_k=\dfrac{1}{3}\pi r^{2}h=\dfrac{1}{3}\pi\cdot 9\cdot 8=24\pi.$$
2. Yarım küre hacmi (tam kürenin yarısı):
$$V_{yk}=\dfrac{1}{2}\cdot\dfrac{4}{3}\pi r^{3}=\dfrac{2}{3}\pi\cdot 3^{3}=\dfrac{2}{3}\pi\cdot 27=18\pi.$$
3. Toplam: $24\pi+18\pi=42\pi$.
(Çeldirici: yarım küre yerine tam küre alan $24\pi+36\pi=60\pi$ ya da koninin $\tfrac13$'ünü unutan kişi şaşar.)
...
1. Yüzey alanı $2(ab+bc+ac)$:
$$2(5\cdot 4+4\cdot 3+5\cdot 3)=2(20+12+15)=2\cdot 47=94\ \text{cm}^{2}.$$
2. Maliyet: $94\cdot 0{,}5=47$ kuruş.
(Çeldirici: yüzey alanı $94$'ü doğrudan cevap sanan C şıkkına, ya da $2$ çarpanını unutup $47\cdot 0{,}5$ yapan başka şıkka düşer.)
...
$$V=\dfrac{1}{3}\,a^{2}h=\dfrac{1}{3}\cdot 4^{2}\cdot 12=\dfrac{1}{3}\cdot 16\cdot 12=64\ \text{cm}^{3}.$$
2. $8$ tanesinin toplam hacmi: $8\cdot 64=512$ cm³.
3. Bu hacim bir küpün hacmi olduğundan kenar:
$$a^{3}=512\Rightarrow a=\sqrt[3]{512}=8\ \text{cm}.$$
(Çeldirici: $\tfrac13$ çarpanını unutup piramit hacmini $192$ alan, ya da $512$'nin küpkökü yerine kenarı $4$ veya $16$ sanan tuzağa düşer.)
...
1. Eski hacim $V=\pi r^{2}h$.
2. Yeni hacim, yükseklik $2h$ olunca:
$$V'=\pi r^{2}(2h)=2\pi r^{2}h=2V.$$
3. Oran $\dfrac{V'}{V}=2$.
(Çeldirici: yarıçap değişmediği halde $2^{2}=4$ kat sanan, ya da $r$ de iki katına çıkmış gibi $8$ kat diyen tuzağa düşer.)
