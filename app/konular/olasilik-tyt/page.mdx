...
Bir torbada $3$ kırmızı ve $5$ mavi bilye vardır. Torbadan rastgele **bir** bilye çekildiğinde kırmızı gelme olasılığı kaçtır?

A) $\dfrac{3}{8}$ · B) $\dfrac{3}{5}$ · C) $\dfrac{5}{8}$ · D) $\dfrac{1}{3}$ · E) $\dfrac{2}{3}$

</Soru>

<Cozum>

1. Toplam $8$ bilye, $3$'ü kırmızı.
2. $P(\text{kırmızı})=\dfrac{3}{8}$.

<Cevap>A) $\dfrac{3}{8}$</Cevap>
...
İki zar birlikte atılıyor. Üst yüzlerin toplamının $7$ olma olasılığı kaçtır?

A) $\dfrac{1}{12}$ · B) $\dfrac{1}{9}$ · C) $\dfrac{1}{6}$ · D) $\dfrac{5}{36}$ · E) $\dfrac{7}{36}$

</Soru>

<Cozum>

1. Toplam $36$ eş olası durum.
2. Toplamı $7$ yapan çiftler: $(1,6),(2,5),(3,4),(4,3),(5,2),(6,1)$ → $6$ durum.
3. $P=\dfrac{6}{36}=\dfrac{1}{6}$.

<Cevap>C) $\dfrac{1}{6}$</Cevap>
