...
$f(x)=3x-2$ fonksiyonu için $f(4)+f(-1)$ toplamı kaçtır?
...
$A=\{1,2,3,4\}$ ve $B=\{a,b,c\}$ kümeleri veriliyor. $A$'dan $B$'ye tanımlı kaç farklı fonksiyon yazılabilir?

A) $12$ · B) $27$ · C) $64$ · D) $81$ · E) $256$

</Soru>

<Cozum>

1. Her $a\in A$ için $3$ seçenek vardır; seçimler bağımsızdır.
2. Toplam: $3^{4}=81$.
...
$f(x)=\dfrac{x+1}{x-2}$ fonksiyonu için $f(5)$ değeri kaçtır?
...
1. $f(5)=\dfrac{5+1}{5-2}=\dfrac{6}{3}=2$.
