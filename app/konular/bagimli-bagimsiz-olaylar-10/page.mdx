...
<Altyazi>Şekil 1 — Bağımlı olaylarda ağaç şeması. İkinci aşama dalları $P(B\mid A)$ ve $P(B\mid A')$ **koşulludur** (ilk sonuca göre değişir). Bir yolun olasılığı dalların çarpımıdır; bağımsızlıkta ise $P(B\mid A)=P(B)$ olur ve dallar değişmez.</Altyazi>
...
<Sorular slug="bagimli-bagimsiz-olaylar-10" />
